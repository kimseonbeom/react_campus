...
import {
  CatTitle, CustomInput, DropHeader, DropList, DropOption, FlexDiv, ListHeader,
...
import { calender, dropdownArrow, searchIcon, pageArrow1, pageArrow2, pageArrow3, pageArrow4 } from '../img';
      ...
      <div style={{ width: "100%", minHeight: "731px", backgroundColor: "#f7f7f7" }}>
        ...
        <ListHeader style={{ height: '146px' }}>
          ...
          <FlexDiv style={{ marginTop: '8px' }}>
            ...
            <div style={{ marginLeft: '33px', marginTop: '5px' }}>~</div>
          ...
          <FlexDiv>
            <SearchDrop>
              <DropHeader onClick={toggleOpen}>
                {selected}
                <img src={dropdownArrow} style={{ width: "13px", height: "8px", marginLeft: 'auto', display: 'block', marginTop: '8px' }} alt="dropdown" />
              </DropHeader>
              {open && (
                <DropList>
            ...
            return (
              <ContentBox key={project.project_id} style={{ width: '386px', height: '160px', margin: '0 auto', border: '1px solid #ccc', marginBottom: '10px', marginTop: '13px' }}>
                <Header style={{ paddingTop: '20px', paddingBottom: '11px', height: '37px', alignItems: 'center' }}>
                  ...
                  <ProjectNameText style={{ marginLeft: 'auto', fontSize: '14px' }}>{project.project_name}</ProjectNameText>
                </Header>
                <Hr style={{ margin: '0 auto', width: '366px' }} />
                <Contents style={{ paddingTop: '10px' }}>
                  <Flex style={{ justifyContent: 'flex-start' }}>
                    <div style={{ marginTop: '7px', marginRight: '56px' }}>
                      <ContentText style={{ marginBottom: '15px' }}>로드맵</ContentText>
                      <ContentText>피드백</ContentText>
                    </div>
                    <div style={{ marginTop: '7px', marginRight: '28px' }}>
                      <ContentText style={{ marginBottom: '15px', color: '#2ec4b6' }}>미제출</ContentText>
                      <ContentText style={{ color: '#aaa' }}>미등록</ContentText>
                    </div>
                    <LengthLine />
                    <div style={{ marginTop: '7px', marginLeft: '28px', marginRight: '54px' }}>
                      <ContentText style={{ marginBottom: '15px' }}>담당교수</ContentText>
                      <ContentText>팀장</ContentText>
                    </div>
                    <div style={{ marginTop: '7px' }}>
                      <ContentText style={{ marginBottom: '15px', color: '#aaa' }}>{project.profes_name}</ContentText>
                      <ContentText style={{ color: '#aaa' }}>{project.leader_name}</ContentText>
                    </div>
                  </Flex>
                </Contents>
