...
import useModalStore, { useProjectFeedbackModalStore, useToastStore } from '../commons/modalStore'
...
import { getUserSession, registerEvaluation } from '../api'
...
function ProjectObjectFeedback() {
    ...
    const { visible, rm_id, project_id, memId, hideModal } = useProjectFeedbackModalStore();
